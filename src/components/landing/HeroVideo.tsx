...
const HeroVideo = () => {
  ...
  return <section className="relative h-screen w-full overflow-hidden">
      ...
      {/* Content */}
      <div ref={contentRef} className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
        {/* Logo */}
        <div 
          className="mb-8"
          style={{
        ...
        {/* Title */}
        <h1 
          className="mb-4 text-5xl font-bold uppercase tracking-wider text-foreground md:text-7xl lg:text-8xl"
          style={{
            opacity: isLoaded ? 1 : 0,
            transform: isLoaded ? 'translateY(0)' : 'translateY(15px)',
