...
const RewardCard = ({ title, value, description, index, image }: RewardCardProps) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'relative overflow-visible rounded-2xl border-2 pb-6 pt-40 px-6 transition-all duration-500',
          styles.background,
          styles.border,
          styles.glow
        )}
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-4 left-8 w-1 h-1 rounded-full bg-white/60 animate-float" style={{ animationDelay: '0s' }} />
          <div className="absolute top-12 right-12 w-1.5 h-1.5 rounded-full bg-white/40 animate-float" style={{ animationDelay: '1s' }} />
          <div className="absolute bottom-16 left-16 w-1 h-1 rounded-full bg-white/50 animate-float" style={{ animationDelay: '2s' }} />
        </div>
